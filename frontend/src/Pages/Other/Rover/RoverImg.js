    ...
    return (
     ...
     w="100vw"
      ...
      <Box  display={"flex"} flexDirection={"column"} width={"200vh"}  borderRadius={"3xl"} borderWidth={"1px"}  margin={"2%"} > 
                    <Text fontSize={"2xl"} fontWeight={"bold"}   color={"white"} marginBottom={"3%"} borderBottomWidth={"1px"}> Perservance Rover</Text>
                   ...
                   <Center>
                   <Image align={"center"}
                src={"https://cdn.mos.cms.futurecdn.net/wwjTnTd8xmRA9p4G5sGgr6-650-80.jpg.webp"}
               alt={`Image `}
                 boxSize="80vh"
